...
%Defines the standard deviation, and centre (a,b) of the likelihood
%Edit these so they equal the values you chose when you made the data
s=1;
a=3.14;
b=10;
...
%Also now features a nice colourmap, and rings shwoing 1 and 2 sigma.
